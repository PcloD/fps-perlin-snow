...
function sendMatrices(ctx)
{
    ...
    var mvMatrixError = false;
              // true if no-mvMatrix-member error flagged
    ...
    if (loc != -1)
    {
        if (!ctx.pMatrix)
            ...
            ctx.uniformMatrix4fv(loc, false, ctx.pMatrix);
    }
    ...
    if (loc != -1)
    {
        if (!ctx.mvMatrix)
        {
            ...
            ctx.uniformMatrix4fv(loc, false, ctx.mvMatrix);
    }
    ...
    if (loc != -1)
    {
        ...
        else
        {
            ...
            ctx.uniformMatrix3fv(loc, false, nMatrix);
        }
    }
    ...
    if (loc != -1)
    {
        if (!ctx.tMatrix)
            ...
            ctx.uniformMatrix4fv(loc, false, ctx.tMatrix);
    }
}
